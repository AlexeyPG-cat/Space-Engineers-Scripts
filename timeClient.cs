...
public void DrawSprites(ref MySpriteDrawFrame frame)
{
    ...
    var progressbar = new MySprite()
    {
        Type = SpriteType.TEXTURE,
        Data = "SquareSimple",
        Position = new Vector2(_viewport.Center.X,(_viewport.Position.Y+_viewport.Size.X/15f)),
    ...
    var progressbarstate = new MySprite()
    {
        Type = SpriteType.TEXTURE,
        Data = "SquareSimple",
        Position = new Vector2(_viewport.Center.X+(((1f-(lineEnd-lineStart)))*(_viewport.Size.X*0.95f)/2),(_viewport.Position.Y+_viewport.Size.X/15f)), 
    ...
    var progressbarstate = new MySprite()
    {
        Type = SpriteType.TEXTURE,
        Data = "SquareSimple",
        Position = new Vector2(_viewport.Center.X+(((1f-(lineEnd-lineStart))*-1)*(_viewport.Size.X*0.95f)/2),(_viewport.Position.Y+_viewport.Size.X/15f)), 
        Size = new Vector2((_viewport.Size.X*0.95f)*(lineEnd-lineStart),_viewport.Size.Y/15),
        Color = new Color(255,255,0),
        Alignment = TextAlignment.CENTER
    };
